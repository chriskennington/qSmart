...
public class BluetoothService extends Service implements BluetoothCallbackInterface
{
     ...
     * Alarm
     *
     * If errors last longer than 5 minutes play alarm sound for 20 seconds every
     * 1 minute.
     *
     *
     *
    ...
    private static final int HEALTH_CHECK_SLEEP = 4000;
    ...
    private Thread healthCheckThread = new Thread()
    {
        ...
        public void run()
        {
            ...
            while(runHealthCheck)
            {
                ...
                //TODO Check if alarm should start sounding
    ...
    private Notification buildExceptionNotification()
    {
        ...
        builder.setContentText(exceptionManager.getExceptionString());
    ...
    private class UpdateRunnable implements Runnable
    {
        ...
        public void run()
        {
            ...
            if(unitData.getFlagValue() > lastExceptionFlagValue)
            {
                //new exception
                Log.e(LogTag.EXCEPTIONS, "Added exception");
                lastExceptionFlagValue = unitData.getFlagValue();
                newError = true;
            }
            else if (unitData.getFlagValue() < lastExceptionFlagValue)
            {
                //removed exception
                Log.e(LogTag.EXCEPTIONS, "Removed exception");
                lastExceptionFlagValue = unitData.getFlagValue();
            }*/
